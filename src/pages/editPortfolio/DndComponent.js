...
import { image, emoji, emoji2,Shape } from 'pages/generate/arrays';
        ...
        <div className="parent">
          ...
          <div className="itemBoxCss">
            <details>
              ...
              {image.map((item) => {
                return (
                    <div style={{border:"1px solid black", width:"100px", height:"100px", margin:"auto auto"}} onClick={() => createCommand("IMAGE")}>
