 ...
 // const tags = props.pofolInfo.tag;
  ...
  return (
    <div  style={{ marginLeft: '80px', marginRight: '80px', display: 'inline-flex' }}  >
      <Card className="cardView" sx={{ maxWidth: 300 ,minWidth:300}}  onClick={()=>{
        console.log(location)
      }}>
        <CardActionArea >
          <CardMedia className="cardMedia" component="img" height="190" image={dummy1} alt="green iguana" onClick={
